...
public class CategoryController {
    ...
    public String formEditCategory(@PathVariable Long categoryId, Model model) {
        ...
        if(!model.containsAttribute("category")) {
            model.addAttribute("category", categoryService.findById
                    (categoryId));
        }
        model.addAttribute("colors", Color.values());
    ...
    @RequestMapping(value = "/categories/{categoryId}", method =
            RequestMethod.PUT)
    public String updateCategory(@Valid Category category, BindingResult
        ...
        if(result.hasErrors()){
            ...
            redirectAttributes.addFlashAttribute("org.springframework" +
                    ".validation.BindingResult.category", result);
        ...
        redirectAttributes.addFlashAttribute("flash", new FlashMessage
                ("Category successfully updated!", FlashMessage.Status
                        .SUCCESS));
    ...
    public String addCategory(@Valid Category category, BindingResult result,
        ...
        redirectAttributes.addFlashAttribute("flash", new FlashMessage
                ("Category successfully added!", FlashMessage.Status.SUCCESS));
    ...
    public String deleteCategory(@PathVariable Long categoryId,
        ...
        if(cat.getGifs().size() > 0) {
            redirectAttributes.addFlashAttribute("flash", new FlashMessage
                    ("Only empty categories can be deleted", FlashMessage
                            .Status.FAILURE));
            return String.format("redirect:/categories/%s/edit", categoryId);
        }
        categoryService.delete(cat);
        redirectAttributes.addFlashAttribute("flash", new FlashMessage
                ("Category deleted!", FlashMessage.Status.SUCCESS));
